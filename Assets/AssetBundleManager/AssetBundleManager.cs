...
{	
	...
	public class AssetBundleManager : MonoBehaviour
	{
		...
		{
			BaseDownloadingURL = Path.Combine(GetStreamingAssetsPath(), relativePath);
		}
		...
		{
			Debug.Log ("RemapVariantName " + assetBundleName);
		...
		static protected bool LoadAssetBundleInternal (string assetBundleName, bool isLoadingAssetBundleManifest)
		{
			...
			if (!url.Contains ("://"))
			{
				var aBundle = AssetBundle.LoadFromFile (url);
				if (aBundle != null)
				{
					LoadedAssetBundle loaded = new LoadedAssetBundle(aBundle);
					m_LoadedAssetBundles.Add(assetBundleName, loaded);
					return true;
				}
			}
